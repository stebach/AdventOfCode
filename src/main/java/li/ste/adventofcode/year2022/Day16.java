...
public class Day16 extends Day {
    ...
    private final Map<String, Integer> maxReleaseForTime = new HashMap<>();
    ...
    private int calcMaxRelease(String pos, List<String> open, int timeLeft) {
        if (timeLeft <= 0) {
            return 0;
        }
