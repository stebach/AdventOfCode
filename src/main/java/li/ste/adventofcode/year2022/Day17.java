...
public class Day17 extends Day {
    ...
    public void run() {
        ...
        setSolution1(getTopAfterNumberOfRocks(2022, rockShapes, jetPattern));
        setSolution2(getTopAfterNumberOfRocks(1_000_000_000_000L, rockShapes, jetPattern));
    }

    private long getTopAfterNumberOfRocks(long numberOfRocks, List<RockShape> rockShapes, int[] jetPattern) {
    ...
    private String getLastLines(List<int[]> grid, int len) {
