...
public class Day24 extends Day {
    ...
    private int height;
    private int width;
    private Map<Coordinate, Integer>  blizzards;
    private Coordinate start;
    private Coordinate goal;
    private Set<Coordinate> queue;
    private List<Coordinate> directions;
   ...
   private void addBlizzard(Map<Coordinate, Integer> blizzards, Coordinate coordinate, int direction) {
        if (coordinate.x == 0) {
