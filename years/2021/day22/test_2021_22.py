import solve_2021_22 as subject
import pytest
...
def test_parse_line(puzzle_input, puzzle_input2):
...
def test_count_on(puzzle_input, puzzle_input2, puzzle_input3):
    data = tuple(map(subject.parse_line, puzzle_input))
    assert subject.count_on(data, True) == 39

    data = tuple(map(subject.parse_line, puzzle_input2))
    assert subject.count_on(data, True) == 590784

    data = tuple(map(subject.parse_line, puzzle_input3))
    assert subject.count_on(data) == 2758514936282235
